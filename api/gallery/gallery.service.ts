...
import { checkFilterAndFindInDb } from './gallery.service/checkFilterAndFindInDb';
import { createGalleryObject } from './gallery.service/createGalleryObject';
import { postImageHandler } from './uploadImage/postImageHandler';
...
export class GalleryService {
  ...
  //   return mediaInfo;
  // }
  saveInDb = saveImgInDb;
  postImageHandler = postImageHandler;
  checkFilterAndFindInDb = checkFilterAndFindInDb;
  createGalleryObject = createGalleryObject;
}
